...
void main() {
  ...
  File cssFile = File('packages/shadcn_flutter/icons/radix/iconly.css');
  File woffFile = File('packages/shadcn_flutter/icons/radix/iconly.woff');

  File targetClass = File('packages/shadcn_flutter/lib/src/icons/radix_icons.dart');
  File targetOtf = File('packages/shadcn_flutter/lib/icons/RadixIcons.otf');

  File targetDocsClass = File('packages/docs/lib/radix_icons.dart');
