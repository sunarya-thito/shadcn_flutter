...
void main() {
  ...
  File jsonFile = File('packages/shadcn_flutter/icons/bootstrap/bootstrap-icons.json');
  File woffFile = File('packages/shadcn_flutter/icons/bootstrap/bootstrap-icons.woff');

  File targetClass = File('packages/shadcn_flutter/lib/src/icons/bootstrap_icons.dart');
  File targetOtf = File('packages/shadcn_flutter/lib/icons/BootstrapIcons.otf');

  File targetDocsClass = File('packages/docs/lib/bootstrap_icons.dart');
