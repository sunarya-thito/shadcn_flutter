...
void main() async {
  ...
  final partsDir = Directory('packages/gen/log/analyze_parts');
  ...
  for (int i = 0; i < parts.length; i++) {
    final partFile = File('packages/gen/log/analyze_parts/part_$i.md');
    await partFile.writeAsString(parts[i].join('\n'));
  }
  print('Analysis parts created in packages/gen/log/analyze_parts/');
}
