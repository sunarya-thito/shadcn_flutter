    ...
    testWidgets('shows and dismisses popover using Symbol key', (tester) async {
      await tester.pumpWidget(
        SimpleApp(
          child: Column(
            children: [
              OverlayAnchor(anchor: #myAnchor, child: Text('Anchor Element')),
              Builder(
  ...
  group('Popover positioning (anchor tracking)', () {
    testWidgets(
      ...
      (tester) async {
        ...
        expect(
          popoverRect.top,
          moreOrLessEquals(anchorRect.bottom, epsilon: 2.0),
        );
        expect(
          popoverRect.center.dx,
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        await tester
            .pump(); // apply scroll -> compositing probe detects movement
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        expect(
          ...
          reason: 'popover should hug the overflowing (bottom) edge, not teleport to the top',
        );
      },
    );
  });
