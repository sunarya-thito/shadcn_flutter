...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1268: x0 => new Event(x0),
      _1269: (x0,x1) => x0.dispatchEvent(x1),
      _1270: (x0,x1,x2) => new ShadcnAppTheme(x0,x1,x2),
      _1271: x0 => new ShadcnAppThemeChangedEvent(x0),
      _1272: x0 => x0.globalThis,
      _1273: (x0,x1) => x0.shadcnAppLoaded = x1,
      _1274: x0 => x0.ShadcnApp,
      _1275: () => globalThis.window,
      ...
      _1294: (x0,x1) => x0.getItem(x1),
      _1296: (x0,x1,x2) => x0.setItem(x1,x2),
      _1297: Date.now,
      _1299: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _1300: s => {
      ...
      _1302: () => typeof dartUseDateNowForTicks !== "undefined",
      _1303: () => 1000 * performance.now(),
      _1304: () => Date.now(),
      _1305: () => {
      ...
      _1307: () => new WeakMap(),
      _1308: (map, o) => map.get(o),
      _1309: (map, o, v) => map.set(o, v),
      _1310: x0 => new WeakRef(x0),
      _1311: x0 => x0.deref(),
      _1317: () => globalThis.WeakRef,
      _1322: s => JSON.stringify(s),
      _1323: s => printToConsole(s),
      _1324: (o, p, r) => o.replaceAll(p, () => r),
      _1326: Function.prototype.call.bind(String.prototype.toLowerCase),
      _1327: s => s.toUpperCase(),
      _1328: s => s.trim(),
      _1329: s => s.trimLeft(),
      _1330: s => s.trimRight(),
      _1331: (string, times) => string.repeat(times),
      _1332: Function.prototype.call.bind(String.prototype.indexOf),
      _1333: (s, p, i) => s.lastIndexOf(p, i),
      _1334: (string, token) => string.split(token),
      _1335: Object.is,
      _1336: (a, i) => a.push(i),
      ...
      _1348: (a, i) => a[i],
      _1349: (a, i, v) => a[i] = v,
      _1350: (a, t) => a.concat(t),
      _1351: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1352: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1353: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1354: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1355: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1356: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1357: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      ...
      _1361: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      ...
      _1410: (handle) => clearTimeout(handle),
      _1411: (ms, c) =>
      setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
      _1412: (handle) => clearInterval(handle),
      _1413: (c) =>
      queueMicrotask(() => dartInstance.exports.$invokeCallback(c)),
      _1414: () => Date.now(),
      _1415: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1416: (x0,x1) => globalThis.fetch(x0,x1),
      _1417: (x0,x1) => x0.get(x1),
      _1418: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1418(f,arguments.length,x0,x1,x2) }),
      _1419: (x0,x1) => x0.forEach(x1),
      _1420: x0 => x0.abort(),
      _1421: () => new AbortController(),
      ...
      _1533: () => globalThis.document,
      _1553: x0 => x0.src,
      _1554: (x0,x1) => x0.src = x1,
      _1555: x0 => x0.naturalWidth,
      _1556: x0 => x0.naturalHeight,
      _1572: x0 => x0.status,
      _1573: (x0,x1) => x0.responseType = x1,
      _1575: x0 => x0.response,
...
"packages/shadcn_flutter/GeistMono",
"italic",
"GeistMono",
"shadcn/ui Flutter",
"system",
...
"SelectionPosition.",
"RadixIcons",
"_CopyWithButtonStyle(_delegate: ",
", _decoration: ",
", _mouseCursor: ",
", _padding: ",
", _textStyle: ",
...
"_barrierEntry",
"_overlayEntry",
"_allowInvertHorizontal",
"_allowInvertVertical",
"_margin",
"_offset",
"_heightConstraint",
"_widthConstraint",
...
" + ",
"editable",
"Caret position is out of bounds.",
...
"_snapshot",
"futureCode",
"https://github.com/sunarya-thito/shadcn_flutter/blob/master/docs/",
"platformDefault",
"inAppWebView",
"inAppBrowserView",
"https:",
...
"Invalid position ",
"_grammar",
"https://raw.githubusercontent.com/sunarya-thito/shadcn_flutter/master/docs/",
"HA==",
"Invalid status code ",
...
" visibleBounds: ",
"pushing ",
"Enable swiping gestures to open a drawer or a sheet.",
"Example 1",
"lib/pages/docs/components/swiper/swiper_example_1.dart",
"Swipe me!",
"Left",
"Right",
"Top",
"Bottom",
"Unresolved position",
"ButtonStyleOverrideData(decoration: ",
"Item ",
"Hello!",
"Text input with formatted parts.",
...
"02",
"2021",
"FormattedValuePart{part: ",
", value: ",
"A Navigation Rail that can be expanded or collapsed",
"Example",
...
"Window Example",
"lib/pages/docs/components/window/window_example_1.dart",
"Window 1",
"Window 2",
"Add Window",
"Desktop",
...
"Tab Pane Example",
"lib/pages/docs/components/tab_pane/tab_pane_example_1.dart",
"Tab ",
"Gradient()",
"modulate",
...
", count: ",
", content: ",
"A table displays data in a tabular format.",
"lib/pages/docs/components/table/table_example_1.dart",
"Resizable Example",
"lib/pages/docs/components/table/table_example_2.dart",
"Scrollable Example",
"lib/pages/docs/components/table/table_example_3.dart",
"free",
...
"Total",
"$2,300.00",
"A timeline animation is a way of displaying a list of events in chronological order, sometimes described as a project artifact with animations.",
...
"`: have you defined a member accessor in the ExpressionEvaluator?",
...
"A trigger that can be used to refresh a list.",
"Pull Me",
"Refresh",
"refreshing",
"pulling",
...
"I miss Y2K Pop",
"Runtober",
"A widget that displays a keyboard key.",
"lib/pages/docs/components/keyboard_display/keyboard_display_example_1.dart",
"An app bar is a bar that appears at the top of the screen.",
"lib/pages/docs/components/app_bar/app_bar_example_1.dart",
"This is Header",
"This is Title",
"This is Subtitle",
"A radio card is a card that can be selected.",
...
"4-core CPU",
"16 GB RAM",
"lib/pages/docs/components/scaffold/scaffold_example_1.dart",
"Scaffold Example",
"A scaffold is a top-level container for a page.",
"Counter App",
...
"lib/pages/docs/components/tracker/tracker_example_1.dart",
"Tracker Fine",
"Fine",
"Tracker Warning",
"Warning",
...
"lib/pages/docs/components/tree/tree_example_1.dart",
"Red Apple 1",
"Red Apple 2",
"Green Banana",
"Green Banana 1",
...
"Collapse All",
"Expand Icon",
"Use Path Branch Line",
"Recursive Selection",
"A sortable is a way of displaying a list of items in a way that allows the user to change the order of the items.",
"lib/pages/docs/components/sortable/sortable_example_1.dart",
"Locked Axis Example",
"lib/pages/docs/components/sortable/sortable_example_2.dart",
"Horizontal Example",
"lib/pages/docs/components/sortable/sortable_example_3.dart",
"ListView Example",
"lib/pages/docs/components/sortable/sortable_example_4.dart",
"Drag Handle Example",
"lib/pages/docs/components/sortable/sortable_example_5.dart",
"Remove Item Example",
"lib/pages/docs/components/sortable/sortable_example_6.dart",
"David",
"Richard",
"Joseph",
"Thomas",
...
"Timeline Example",
"lib/pages/docs/components/timeline/timeline_example_1.dart",
...
"2022-01-03",
"Third event",
"A stepper is a fundamental part of material design guidelines. Steppers convey progress through numbered steps.",
"Vertical Example",
"lib/pages/docs/components/stepper/stepper_example_1.dart",
"lib/pages/docs/components/stepper/stepper_example_2.dart",
"Failed Step Example",
"lib/pages/docs/components/stepper/stepper_example_3.dart",
"Clickable Step Example",
"lib/pages/docs/components/stepper/stepper_example_4.dart",
"Custom Icon Example",
"lib/pages/docs/components/stepper/stepper_example_5.dart",
"Variants Example",
"lib/pages/docs/components/stepper/stepper_example_6.dart",
"StepperValue{stepStates: ",
", currentStep: ",
"Horizontal",
"Vertical",
"Circle",
...
"lib/pages/docs/components/chip/chip_example_1.dart",
"Durian",
"A widget that allows users to input phone numbers.",
...
"dominicanRepublic",
"+1829",
"dominicanRepublic1829",
"+1849",
"dominicanRepublic1849",
"Ecuador",
"EC",
"+593",
"🇪🇨",
...
"ReachabilityError: ",
"countryFlags_RoundedRectangularFlag_SizedBox",
"packages/country_flags/res/si/",
".si",
"svgFlag",
"_preferredSize",
"_painter",
...
"lib/pages/docs/components/toast/toast_example_1.dart",
...
"Accordion component for Flutter.",
"Alert component for Flutter.",
"Alert Dialog component for Flutter.",
"Animation component for Flutter.",
"Avatar component for Flutter.",
"Badge component for Flutter.",
"Blog",
"Stay updated with the latest news.",
"Latest news",
"View the change log of this package.",
"Change log",
"List of contributors to this package.",
"Contributors",
"Documentation",
"_anchorContext",
...
"lib/pages/docs/components/menubar/menubar_example_1.dart",
"File",
"New Tab",
"New Window",
...
"Edit...",
"Add Profile...",
"A resizable pane widget, support resize child widget.",
"lib/pages/docs/components/resizable/resizable_example_1.dart",
"lib/pages/docs/components/resizable/resizable_example_2.dart",
"Horizontal Example with Dragger",
"lib/pages/docs/components/resizable/resizable_example_3.dart",
"Controller Example",
"lib/pages/docs/components/resizable/resizable_example_4.dart",
"Collapsible Example",
"lib/pages/docs/components/resizable/resizable_example_5.dart",
"Nested Example",
"lib/pages/docs/components/resizable/resizable_example_6.dart",
"Dynamic Children Example",
"lib/pages/docs/components/resizable/resizable_example_7.dart",
"Insert Before",
"Remove",
"Insert After",
"_panelSize",
...
"_innerController",
"_outerController",
"Use this code to display this icon:",
"Icon(",
"viewVertical",
"viewNone",
"viewHorizontal",
...
"lib/pages/docs/components/sheet/sheet_example_1.dart",
"Open Sheet",
"Edit profile",
...
"lib/pages/docs/components/drawer/drawer_example_1.dart",
"Open Drawer",
"Drawer ",
"Open Another Drawer",
"Close Drawer",
"Toggle is a widget that can be used to switch between two states.",
"lib/pages/docs/components/toggle/toggle_example_1.dart",
"Group Example",
"lib/pages/docs/components/toggle/toggle_example_2.dart",
"B",
"I",
"U",
"This component uses widget from ",
"https://pub.dev/packages/skeletonizer",
"lib/pages/docs/components/skeleton/skeleton_example_1.dart",
...
"Resizable Height Example",
"lib/pages/docs/components/text_area/text_area_example_1.dart",
"Resizable Width Example",
"lib/pages/docs/components/text_area/text_area_example_2.dart",
"Resizable Width and Height Example",
"lib/pages/docs/components/text_area/text_area_example_3.dart",
"Hello, World!",
"_width",
"_height",
"Input OTP is a component that allows users to enter OTP code.",
"lib/pages/docs/components/input_otp/input_otp_example_1.dart",
"Initial Value Example",
"lib/pages/docs/components/input_otp/input_otp_example_2.dart",
"Obscured Example",
"lib/pages/docs/components/input_otp/input_otp_example_3.dart",
"Upper Case Alphabet Example",
"lib/pages/docs/components/input_otp/input_otp_example_4.dart",
"123",
"Submitted Value: ",
"A list of tabs for selecting a single item.",
"Tabs Example",
"lib/pages/docs/components/tabs/tabs_example_1.dart",
"Tab 1",
"Tab 2",
"Tab 3",
"A visual indicator of an operation's progress.",
"Progress Example",
"lib/pages/docs/components/progress/progress_example_1.dart",
"Decrease by 10",
"Increase by 10",
"A floating message that appears when a user interacts with a target.",
"Popover Example",
"lib/pages/docs/components/popover/popover_example_1.dart",
"Open popover",
"Popover closed",
"Dimensions",
...
"Submit",
"Tooltip Example",
"lib/pages/docs/components/tooltip/tooltip_example_1.dart",
"This is a tooltip.",
"Hover over me",
"Tab List Example",
"lib/pages/docs/components/tab_list/tab_list_example_1.dart",
"A series of steps for progress.",
"Steps Example",
"lib/pages/docs/components/steps/steps_example_1.dart",
"Create a project",
...
"Slider Example",
"lib/pages/docs/components/slider/slider_example_1.dart",
"Slider with Range Example",
"lib/pages/docs/components/slider/slider_example_2.dart",
"Slider with Divisions Example",
"lib/pages/docs/components/slider/slider_example_3.dart",
" - ",
"A switch is a visual toggle between two mutually exclusive states — on and off.",
"Switch Example",
"lib/pages/docs/components/switch/switch_example_1.dart",
"A radio group is a group of radio buttons.",
...
"lib/pages/docs/components/input/input_example_1.dart",
"lib/pages/docs/components/input/input_example_2.dart",
"Features Example",
"lib/pages/docs/components/input/input_example_3.dart",
"Revalidate Form Feature Example",
"lib/pages/docs/components/input/input_example_4.dart",
"Enter your username",
"Qw==",
...
"lib/pages/docs/components/dialog/dialog_example_1.dart",
"Edit Profile",
"Make changes to your profile here. Click save when you're done",
"@sunaryathito",
"A widget that lets users select dates and date ranges.",
"Date Picker Example",
...
"lib/pages/docs/components/calendar/calendar_example_1.dart",
"Single Calendar Example",
"lib/pages/docs/components/calendar/calendar_example_2.dart",
"Multiple Calendar Example",
"lib/pages/docs/components/calendar/calendar_example_3.dart",
"Calendar Example",
"lib/pages/docs/components/calendar/calendar_example_4.dart",
"A carousel slider widget, support infinite scroll and custom child widget.",
"Horizontal Carousel Example",
"lib/pages/docs/components/carousel/carousel_example_1.dart",
"Vertical Carousel Example",
"lib/pages/docs/components/carousel/carousel_example_2.dart",
"Fading Carousel Example",
"lib/pages/docs/components/carousel/carousel_example_3.dart",
"Continuous Sliding Carousel Example",
"lib/pages/docs/components/carousel/carousel_example_4.dart",
"CarouselAlignment.",
"A helper widget that makes it easy to validate forms.",
"Form Example (Table Layout)",
"lib/pages/docs/components/form/form_example_1.dart",
"Form Example (Column Layout)",
"lib/pages/docs/components/form/form_example_2.dart",
"Validation Mode Example",
"lib/pages/docs/components/form/form_example_3.dart",
"confirmPassword",
"shadcn",
...
"Command Example",
"lib/pages/docs/components/command/command_example_1.dart",
"Suggestions",
"Search Emoji",
"Launch",
"Mail",
"A widget that can be expanded or collapsed.",
"lib/pages/docs/components/collapsible/collapsible_example_1.dart",
"@sunarya-thito starred 3 repositories",
...
"lib/pages/docs/components/divider/divider_example_1.dart",
"Vertical Divider Example",
"lib/pages/docs/components/divider/divider_example_2.dart",
"Divider with Text Example",
"lib/pages/docs/components/divider/divider_example_3.dart",
"Item 1",
"Item 2",
"Item 3",
"A select component that allows you to select an item from a list of items.",
"lib/pages/docs/components/select/select_example_1.dart",
"lib/pages/docs/components/select/select_example_2.dart",
"lib/pages/docs/components/select/select_example_3.dart",
"Example with no virtualization",
"lib/pages/docs/components/select/select_example_4.dart",
"intrinsic",
...
"Circular Progress with Value Example",
"lib/pages/docs/components/circular_progress/circular_progress_example_2.dart",
"A code snippet is a small piece of reusable code.",
"Code Snippet Example",
"lib/pages/docs/components/code_snippet/code_snippet_example_1.dart",
"flutter pub get",
"Checkboxes allow the user to select one or more items from a set.",
"Checkbox Example",
"lib/pages/docs/components/checkbox/checkbox_example_1.dart",
"Checkbox Example with Tristate",
"lib/pages/docs/components/checkbox/checkbox_example_2.dart",
"Remember me",
"Cards are surfaces that display content and actions on a single topic.",
"Card Example",
"lib/pages/docs/components/card/card_example_1.dart",
"Create project",
...
"lib/pages/docs/components/button/button_example_1.dart",
"Secondary Button Example",
"lib/pages/docs/components/button/button_example_2.dart",
"Outline Button Example",
"lib/pages/docs/components/button/button_example_3.dart",
"Ghost Button Example",
"lib/pages/docs/components/button/button_example_4.dart",
"Destructive Button Example",
"lib/pages/docs/components/button/button_example_5.dart",
"Link Button Example",
"lib/pages/docs/components/button/button_example_6.dart",
"Text Button Example",
"lib/pages/docs/components/button/button_example_12.dart",
"Disabled Button Example",
"lib/pages/docs/components/button/button_example_7.dart",
"Icon Button Example",
"lib/pages/docs/components/button/button_example_8.dart",
"Icon Button with Label Example",
"lib/pages/docs/components/button/button_example_9.dart",
"Button Size Example",
"lib/pages/docs/components/button/button_example_10.dart",
"Button Density Example",
"lib/pages/docs/components/button/button_example_11.dart",
"Button Shape Example",
"lib/pages/docs/components/button/button_example_13.dart",
"Button Group Example",
"lib/pages/docs/components/button/button_example_14.dart",
"Button Stated Example",
"lib/pages/docs/components/button/button_example_15.dart",
"Card Button Example",
"lib/pages/docs/components/button/button_example_16.dart",
"Custom Button Example",
"lib/pages/docs/components/button/button_example_17.dart",
"Custom Button",
"Project #1",
"Project description",
"Normal",
...
"lib/pages/docs/components/badge/badge_example_1.dart",
"Secondary Badge Example",
"lib/pages/docs/components/badge/badge_example_2.dart",
"Outline Badge Example",
"lib/pages/docs/components/badge/badge_example_3.dart",
"Destructive Badge Example",
"lib/pages/docs/components/badge/badge_example_4.dart",
"Outline",
"Avatars are used to represent people or objects.",
"Avatar Example",
"lib/pages/docs/components/avatar/avatar_example_1.dart",
"Avatar Example with Username Initials",
"lib/pages/docs/components/avatar/avatar_example_2.dart",
"Avatar Example with Badge",
"lib/pages/docs/components/avatar/avatar_example_3.dart",
...
"Alert Example",
"lib/pages/docs/components/alert/alert_example_1.dart",
"Alert Example with destructive",
"This is alert content.",
"lib/pages/docs/components/alert/alert_example_2.dart",
"An accordion is a vertically stacked list of items. Each item can be \"expanded\" or \"collapsed\" to reveal the content associated with that item.",
"Accordion Example",
"lib/pages/docs/components/accordion/accordion_example_1.dart",
...
"Passing Data to the Children",
"Getting Data from the Child",
"MultiData Widget",
"Passing State as a Controller",
"DataBuilder",
"DataNotifier",
"Passing Variable to Children",
"ModelNotifier",
"ModelListenable",
"ModelBuilder",
...
"Internally, shadcn_flutter has its own state management system. Although if you are already using a state management system, you can continue to use it with shadcn_flutter.",
"You can pass data to children using the Data widget. Any changes that occur in the data will cause the child to rebuild.",
"lib/pages/docs/state/data_example_1.dart",
"Did you notice the difference in the rebuild count?",
"The MostInnerWidget rebuilds when the data changes while the InnerWidget does not. This is because the InnerWidget is not listening to the data.",
"Setting Data Boundary",
"You can set a boundary so that the child cannot access the data.",
"lib/pages/docs/state/data_example_4.dart",
"Data.maybeOf/Data.of vs Data.maybeFind/Data.find",
"Data.maybeOf(context)",
"Data.of(context)",
" listens to the data and rebuilds the widget when the data changes. Meanwhile ",
"Data.maybeFind(context)",
"Data.find(context)",
" does not listen to the data and only returns the data.",
"lib/pages/docs/state/data_example_5.dart",
...
"You can get data from the child using the ",
"Data.maybeFindMessenger(context)",
" method. This method does not listen to any changes that occur in the data. ",
"Listening to child data might cause infinite rebuild loops. Move the data to the parent widget if you need to listen to it.",
"lib/pages/docs/state/data_example_2.dart",
"Did you notice the root data?",
"It uses the data from the left most inner data, because parent can only take data from the first attached child.",
"Setting DataMessenger Boundary",
"You can set a boundary so that child data cannot be obtained from specific parent.",
"lib/pages/docs/state/data_example_3.dart",
...
"MultiData(\n\tdataList: [\n\t\tData<int>(counter),\n\t\tData<String>(name),\n\t\tData<bool>.boundary(),\n\t],\n\tchild: child,\n)",
"lib/pages/docs/state/data_example_6.dart",
"You can pass state as a controller to the children. This way you can call method in parent widget from child widgets.",
"lib/pages/docs/state/data_example_7.dart",
"You can use the DataBuilder widget to rebuild the widget when the data changes. This also avoids rebuilding the entire widget.",
"lib/pages/docs/state/data_example_8.dart",
"Data notifier allows you to pass value to children from a ValueListenable.",
"lib/pages/docs/state/data_example_9.dart",
"Example with MultiData",
"lib/pages/docs/state/data_example_10.dart",
"Passing Object as Data",
"There are several things you need to consider when passing an object as data:",
"1. Override == and hashCode",
"Children will be notified when the old object is not equal to the new object. If you do not override == and hashCode, the object will always be considered different every time the object is instantiated even if the object has the same field values.",
"lib/pages/docs/state/data_example_16.dart",
"2. Use DistinctData",
"DistinctData is a mixin that allows you to notify children when specific fields change.",
"lib/pages/docs/state/data_example_17.dart",
"3. Passing Mutable Object to Children",
"It is recommended to pass an immutable object to the children. Mutable object (e.g. List, Map, Set, Widget State) will not notify the children when the object is mutated because the object reference does not change. ",
...
"lib/pages/docs/state/data_example_11.dart",
"Change Variable from Children",
"There are 2 ways to change model value from children:",
"lib/pages/docs/state/data_example_12.dart",
...
"lib/pages/docs/state/data_example_13.dart",
...
"lib/pages/docs/state/data_example_14.dart",
...
"lib/pages/docs/state/data_example_15.dart",
"SQ==",
"Sg==",
...
"First Counter: ",
"Data: ",
" - MostInnerWidget Rebuild Count: ",
" - InnerWidget Rebuild Count: ",
"Current Value: ",
" - Rebuild Count: ",
"MostInnerWidget Data: ",
"InnerWidget Rebuild Count: ",
"Increment Counter",
"Rebuild: ",
" - Root Data: ",
...
"Reset Options",
"500 (Base)",
"Use this code to display this color:",
"Colors.",
"Customize how flutter load your web application",
...
"Open your ",
"index.html",
" file and paste the script inside the ",
"<head>",
" tag.",
"For example:",
"<!DOCTYPE html>\n<html>\n  <head>\n    ...\n    <script src=\"https://cdn.jsdelivr.net/gh/sunarya-thito/shadcn_flutter@latest/web_loaders/standard.js\"></script>\n    ...\n  </head>\n  ...\n</html>\n                      ",
...
"lib/pages/docs/components/material/material_example_1.dart",
"Material Example",
"lib/pages/docs/components/material/cupertino_example_1.dart",
"Cupertino Example",
...
"lib/pages/docs/layout_page/layout_page_example_1.dart",
"lib/pages/docs/layout_page/layout_page_example_2.dart",
"lib/pages/docs/layout_page/layout_page_example_3.dart",
"lib/pages/docs/layout_page/layout_page_example_4.dart",
"lib/pages/docs/layout_page/layout_page_example_5.dart",
"lib/pages/docs/layout_page/layout_page_example_6.dart",
"lib/pages/docs/layout_page/layout_page_example_7.dart",
"Title",
" Item 1 ",
" Item 2 ",
" Item 3 ",
...
"Use the following code to apply the color scheme.",
"ShadcnApp(",
"\n...",
"\n\ttheme: ThemeData(",
...
"To use an experimental version, use git instead of version number in your pubspec.yaml file:",
...
"Links",
"Welcome to shadcn_flutter, a versatile and comprehensive set of UI components designed specifically for Flutter desktop and web applications. With the growing popularity of Flutter for building cross-platform apps, we recognized the need for a toolkit that emphasizes the unique design requirements of desktop and web interfaces.",
"\tThis package provides a wide range of customizable and responsive components that align with modern desktop and web design principles. Whether youre building a sophisticated business application, a sleek dashboard, or a productivity tool, our components are designed to help you create professional and polished UIs quickly and efficiently.",
...
"Pre-made themes from Shadcn/UI.",
"Supports mobile, web, and desktop platforms.",
"Supports middle drag scrolling.",
"Various widget extensions for typography purposes.",
"Supports WebAssembly for better performance.",
"This package is still in development and may have breaking changes in the future. Please be cautious when using this package in production.",
...
"Unfortunately you can't. This package only supports New York style. But if you wish to have default style of Shadcn/UI, i would recommend ",
"this package",
" by ",
"@nank1ro",
...
"Bad code ",
"strings",
"Attempt to read beyond end of input",
"EOFException: ",
"floatValues",
"SITextAnchor.",
"w100",
...
"    Ignoring ",
"    This warning can be silenced with ScalableImage.imageDisposeBugWorkaround.",
"    See  https://github.com/zathras/jovial_svg/issues/62",
"    Stack trace: ",
"Object is disposed",
"_bounds",
...
"AnimatableValue(",
"Could not lerp ",
". You must provide a custom lerp function.",
"hello world",
"lorem ipsum",
"do re mi",
"foo bar",
...
"restoring ",
"Not in cache",
"Extra attempt to removeReference",
...
"ScaffoldBoxConstraints(headerHeight: ",
", footerHeight: ",
", minWidth: ",
", maxWidth: ",
", minHeight: ",
