...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1300: x0 => x0.cancel(),
      _1303: x0 => x0.read(),
      _1309: x0 => new Event(x0),
      _1310: (x0,x1) => x0.dispatchEvent(x1),
      _1311: (x0,x1,x2) => new ShadcnAppTheme(x0,x1,x2),
      _1312: x0 => new ShadcnAppThemeChangedEvent(x0),
      _1313: x0 => x0.globalThis,
      _1314: (x0,x1) => { x0.shadcnAppLoaded = x1 },
      _1315: x0 => x0.ShadcnApp,
      _1316: () => globalThis.window,
