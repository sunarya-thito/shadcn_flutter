...
class _CodeSnippetFutureBuilderState extends State<CodeSnippetFutureBuilder> {
  ...
  void _refresh() {
    ...
    String url =
        'https://raw.githubusercontent.com/sunarya-thito/shadcn_flutter/master/shadcn_flutter/docs/${widget.path}';
    futureCode =
              ...
              actions: [
                GhostButton(
                  ...
                  onPressed: () {
                    // open in new tab
                    String url =
                        'https://github.com/sunarya-thito/shadcn_flutter/blob/master/shadcn_flutter/docs/${widget.path}';
