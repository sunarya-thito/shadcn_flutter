...
class ColorSchemes {
  ...
  static const ColorScheme darkBlue = ColorScheme(
  ...
  static const ColorScheme darkGreen = ColorScheme(
    brightness: Brightness.dark,
    background: Color(0xFF09090B),
    foreground: Color(0xFFFAFAFA),
    card: Color(0xFF18181B),
  ...
  static const ColorScheme darkOrange = ColorScheme(
    brightness: Brightness.dark,
    background: Color(0xFF09090B),
    foreground: Color(0xFFFAFAFA),
    card: Color(0xFF18181B),
  ...
  static const ColorScheme darkRed = ColorScheme(
    brightness: Brightness.dark,
    background: Color(0xFF09090B),
    foreground: Color(0xFFFAFAFA),
    card: Color(0xFF18181B),
  ...
  static const ColorScheme darkRose = ColorScheme(
    brightness: Brightness.dark,
    background: Color(0xFF09090B),
    foreground: Color(0xFFFAFAFA),
    card: Color(0xFF18181B),
  ...
  static const ColorScheme darkViolet = ColorScheme(
    brightness: Brightness.dark,
    background: Color(0xFF09090B),
    foreground: Color(0xFFFAFAFA),
    card: Color(0xFF18181B),
  ...
  static const ColorScheme darkYellow = ColorScheme(
    brightness: Brightness.dark,
    background: Color(0xFF09090B),
    foreground: Color(0xFFFAFAFA),
    card: Color(0xFF18181B),
